...
exports.default = new Router({
	routes: [{ url: '', params: { page: 'home-page' } }, { url: 'user-list', params: { page: 'user-list' } }, { url: 'about', params: { page: 'about-page' } }]
});

},{"crossroads":1,"hasher":3,"knockout":6}],8:[function(require,module,exports){
"use strict";
...
var _userList = require("./components/user-list/user-list");
...
_knockout2.default.components.register("user-list", _userList2.default);
...
var _userList = require("./user-list.html");
...
var UserList = function UserList() {
	...
	this.userList = _knockout2.default.observableArray();
	...
	_jquery2.default.ajax({
		...
		_this.userList(_knockout2.default.utils.arrayMap(data, function (item) {
